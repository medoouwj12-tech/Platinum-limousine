...
const translations = {
    en: {
        ...
        "offer-name": "عرض الرحلة بـ 1100 جنيه",
        "offer-how-title": "للاستفادة من العرض، النظام كالتالي:",
        "offer-trip1": "🚘 الرحلة الأولى (بالسعر العادي)",
        "offer-trip2": "الرحلة الثانية",
        "offer-sedan": "سيدان",
        "offer-xpander": "إكسباندر",
        "offer-flat": "(سعر موحد)",
        "offer-terms-title": "📋 شروط العرض:",
        "offer-term1": "العرض ساري حتى نهاية شهر يوليو",
        "offer-term2": "يسري على رحلات الإسكندرية ⇄ القاهرة أو الإسكندرية ⇄ مطار القاهرة في الاتجاهين",
        "offer-term3": "العرض متاح على سيارات السيدان والإكسباندر فقط",
        "offer-term4": "يمكن لكل عميل الاستفادة من العرض أكثر من مرة",
        "offer-term5": "الدفع كاش أو إنستا باي بعد انتهاء الرحلة",
        "offer-booking-title": "📞 للحجز أو الاستفسار، أرسل لنا:",
        "offer-b1": "مكان التحرك",
        "offer-b2": "الوجهة",
        "offer-b3": "تاريخ الرحلة",
        "offer-b4": "موعد التحرك",
        "offer-b5": "عدد الركاب والحقائب",
        "offer-btn": "احجز العرض الآن",
        // Fleet
